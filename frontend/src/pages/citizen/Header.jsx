...
export default function Header({ voterData }) {
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs font-body text-muted">
                Welcome back, {voterData?.voter_name}
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            <button className="relative p-2 text-muted bg-white hover:bg-neutral-200 hover:text-ink rounded-full transition-colors">
              ...
              <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-light rounded-full"></span>
            </button>
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              {showDropdown && (
                <div className="absolute right-0 mt-2 w-48 bg-paper rounded-xl shadow-lg border border-gray-300 z-50 overflow-hidden">
                  {/* Voter Info */}
                  <div className="px-4 py-3 border-b border-gray-200">
                    <p className="text-sm font-body font-medium text-ink">
                      {voterData?.voter_name}
                    </p>
